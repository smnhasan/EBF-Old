...
COMPUTE disease_count2= 0.
EXECUTE.
IF  (disease_count= 0) disease_count2=0.
IF  (disease_count= 1) disease_count2=1.
IF  (disease_count= 2) disease_count2=2.
IF  (disease_count= 3) disease_count2=3.
IF  (disease_count= 4) disease_count2=4.
IF  (disease_count= 5) disease_count2=4.
EXECUTE.

FREQUENCIES VARIABLES=disease_count2 
/ORDER=ANALYSIS.
